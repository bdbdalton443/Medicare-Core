...
namespace AweCoreDemo.Controllers.Awesome.Grid
{
    public class StockAllocationController : Controller
    {
        ...
        public StockAllocationController(DemoHms.Data.ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Create(Stok input)
        {
            if (ModelState.IsValid)
            {
                ...
                stockRoutine.RoutineTypeID = _context.RoutineType.FirstOrDefault(R => R.Name == "Opening Stock").RoutineTypeID;
        ...
        public IActionResult Edit(Stok input)
        {
            if (ModelState.IsValid)
            {
                ...
                StockRoutine stockRoutine = new StockRoutine();
                stockRoutine.Quantity = dinner.Quantity;
                stockRoutine.RoutineTypeID = _context.RoutineType.FirstOrDefault(R => R.Name == "Stock Allocation").RoutineTypeID;
                stockRoutine.StockID = dinner.StockID;
                _context.StockRoutines.Add(stockRoutine);
                _context.SaveChanges();
