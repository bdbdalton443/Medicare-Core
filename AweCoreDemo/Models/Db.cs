...
namespace AweCoreDemo.Models
{
    public static class Db
    {
        ...
        public static Assignment Assignment { get; set; }
        public static int BillStatusID { get; set; }
        public static int? ExaminationID { get; set; }

        public static bool IsLab { get; set; }
        public static string Message { get; set; }
        public static Examination Examination { get { return Assignment.Examinations.FirstOrDefault(E => E.BillStatusID == BillStatusID); }  }
        ...
        public static bool IsPasswordReset { get; internal set; }

        public static IEnumerable<Meeting> Meetings => meetings.Values.Where(o => !o.IsDeleted);

        public static int? Total { get; internal set; }
        public static Bill Bill { get; internal set; }
        public static bool FirstLoad { get; internal set; }
        ...
        static Db()
        {
            ...
            var countryNames = new[]
                {
                    ...
                    "Ironforge", "Orgrimmar", "Feralas", "Darnassus", "Winterspring", "Teldrassil", 
            ...
            add(new Chef { FirstName = "Charles", LastName = "Duchemin", Country = Rnd(Countries) });            
            ...
            add(new Chef { FirstName = "Casse", LastName = "Croute", Country = Rnd(Countries) });            
            add(new Chef { FirstName = "Fromage", LastName = "Sandwich", Country = Rnd(Countries) });
            add(new Chef { FirstName = "Josh", LastName = "Baskin", Country = Rnd(Countries) });
            add(new Chef { FirstName = "Hercules", LastName = "Oat", Country = Rnd(Countries) });
            add(new Chef { FirstName = "Joanna", LastName = "Stan", Country = Rnd(Countries) });
            add(new Chef { FirstName = "Peter", LastName = "Gibbons", Country = Rnd(Countries) });
            add(new Chef { FirstName = "Tom", LastName = "Smykowski", Country = Rnd(Countries) });
